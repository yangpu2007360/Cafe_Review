...
def add_cafe():
    ...
    if form.validate_on_submit():
        print("Validate Data. I will add it in the csv file.")
...
def cafes():
    with open('cafe-data.csv', newline='') as csv_file:
        ...
        num_of_rows = len(list_of_rows)
    return render_template('cafes.html', cafes=list_of_rows, num_of_rows=num_of_rows)
